...
$query2 = "SELECT COUNT(*) AS total_user FROM users";
            ...
            <ul>
                ...
                <?php if (isset($admin_id)): ?>
                    ...
                    <?php if (isset($moderator_id)): ?>
                        <li><a href="ModeratorOperation.php"><i class="fas fa-user-tie"></i>Moderator Operations</li>
                        <?php endif; ?>
                ...
                <div class="main_content">
                    ...
                    <div class="inner_container">
                        ...
                        <div class="container">
                            <div align="right">
                                <form method="post" action="User_Search.php">
                                    <input type="search" placeholder="Search..." name="search_email">
                                    <button type="submit">Search</button>
                                </form>
                            </div>
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php while ($rows = mysqli_fetch_array($result)) { 
                                        ...
                                        $check_ban_query = "SELECT * FROM ban WHERE banned_user_id = '" . $rows['user_id'] . "'";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style="display: flex; justify-content: center; gap: 10px;">
                                                    ...
                                                    data-user-id="<?php echo $rows['user_id']; ?>" 
                                                    data-user-name="<?php echo $rows['first_name'] . " " . $rows['last_name']; ?>">
                                                    Warn
                                                </button>
                                                <?php if ($is_banned) { ?>
                                                    <a href="unban.php?id=<?php echo $rows['user_id']; ?>" class="btn btn-warning">Unban</a>
                                                <?php } else { ?>
                                                    <a href="ban.php?id=<?php echo $rows['user_id']; ?>" class="btn btn-danger">Ban</a>
                                                <?php } ?>
                                                <a href="delete_user.php?id=<?php echo $rows['user_id']; ?>" class="btn btn-danger">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
                        ...
                        <div>Total Users: <?php echo $row2['total_user']; ?></div>
                        <ul class="pagination">
            ...
            <div class="popup-content">
                ...
                <form id="warnForm" method="post" action="warn.php">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="hidden_value" value="user">
                    </div>
